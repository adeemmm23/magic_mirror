...
Module.register("clock", {
	...
	defaults: {
		...
		analogShowDate: "bottom", // OBSOLETE, can be replaced with analogPlacement and showTime, options: false, 'top', or 'bottom'
		secondsColor: "#888888",
	...
	getDom: function () {
		...
		const dateAnalogWrapper = document.createElement("div");
		...
		dateAnalogWrapper.className = "date materialDate";
		...
		if (this.config.showDate) {
			dateAnalogWrapper.innerHTML = now.format(this.config.dateFormat);
			dateAnalogWrapper.style.textAlign = "center";
			dateAnalogWrapper.style.paddingTop = "219px";

			if (this.config.analogFace === "face-005") {
				dateAnalogWrapper.innerHTML = now.format("ddd D");
				dateAnalogWrapper.style.fontWeight = "bold";
				dateAnalogWrapper.style.paddingTop = "147px";
			}

			analogWrapper.appendChild(dateAnalogWrapper);
		}
